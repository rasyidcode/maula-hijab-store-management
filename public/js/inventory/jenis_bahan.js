$(function() {
    ...
    let datatable = $("#list_jenis_bahan").DataTable(options)
    ...
    function handleButtonsClick() {
        $("#list_jenis_bahan tbody").on("click", "tr button.btn-primary", function () {
        ...
        $("#list_jenis_bahan tbody").on("click", "tr button.btn-info", function() {
            const kode = datatable.row($(this).parent().parent()).data().kode
        ...
        $("#list_jenis_bahan tbody").on("click", "tr button.btn-danger", function() {
